// KPI Derived Form component interface
export interface KpiDerivedFormProps {
  onCreateClick: () => void;
}

export class KpiDerivedForm {
  private props: KpiDerivedFormProps;

  constructor(props: KpiDerivedFormProps) {
    this.props = props;
  }
    ...
    return {
      ...
      content: {
        ...
        description: {
          title: "Derived KPIs",
          text: [
            "For tracking KPIs that are derived from",
            "other DERIVED KPIs or metrics."
          ],
